...
export const ru: Strings = {
  ...
  panelPause: "Приостановить синхронизацию",
  panelPauseDesc: "Синхронизация идёт сама. На паузе она сама не идёт; «Синхронизировать сейчас» работает по-прежнему.",
  panelPausedDesc: "На паузе: сама ничего не синхронизируется. «Синхронизировать сейчас» работает по-прежнему.",
  ...
  // ------------------------------------------------ ローカル固有ファイルの分類
  localIgnoreTitle: "Ваши собственные правила исключения",
  localIgnoreBody:
    "Правила отсюда действуют только для вашего хранилища; этот файл не синхронизируется. Синтаксис тот же, что и в _Sync/ignore.md: # — комментарий, * ? ** — шаблоны, ведущий / привязывает к корню синхронизации, завершающий / совпадает с папками, ! отменяет исключение.",
