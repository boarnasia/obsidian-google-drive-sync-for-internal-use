...
export const ru: Strings = {
  ...
  reasonNoBaseline:
    "Это хранилище ещё не клонировано, и файлы есть с обеих сторон. Сначала выполните clone, чтобы получить удалённую сторону.",
  reasonVaultEmpty:
    "Хранилище пусто, но в базовом состоянии файлы ещё числятся. Выполните clone, чтобы вернуть их, или подтвердите удаления ниже.",
  reasonDeleteGuard: "Эта синхронизация удалила бы больше файлов, чем допускает защитный предел.",
