...
export const ru: Strings = {
  ...
  localIgnoreBody:
    "Правила отсюда действуют только для вашего хранилища; этот файл не синхронизируется. Синтаксис тот же, что и в _Sync/ignore.md: # — комментарий, * ? ** — шаблоны, ведущий / привязывает к корню синхронизации, завершающий / совпадает с папками, ! отменяет исключение, но не для файла внутри исключённой папки.",
