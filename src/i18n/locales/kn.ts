...
export const kn: Strings = {
  ...
  reasonNoBaseline:
    "ಈ ವಾಲ್ಟ್ ಅನ್ನು ಇನ್ನೂ clone ಮಾಡಿಲ್ಲ, ಮತ್ತು ಎರಡೂ ಕಡೆ ಫೈಲ್‌ಗಳಿವೆ. ಮೊದಲು clone ಮಾಡಿ ರಿಮೋಟ್ ಅನ್ನು ಇಲ್ಲಿಗೆ ತನ್ನಿ.",
  reasonVaultEmpty:
    "ವಾಲ್ಟ್ ಖಾಲಿಯಾಗಿದೆ, ಆದರೆ ಆಧಾರ ಪಟ್ಟಿಯಲ್ಲಿ ಫೈಲ್‌ಗಳು ಇನ್ನೂ ಇವೆ. clone ಮಾಡಿ ಮರಳಿ ತನ್ನಿ, ಅಥವಾ ಕೆಳಗಿನ ಅಳಿಸುವಿಕೆಗಳನ್ನು ಅನುಮೋದಿಸಿ.",
  reasonDeleteGuard: "ಈ ಸಿಂಕ್ ಸುರಕ್ಷತಾ ಮಿತಿಗಿಂತ ಹೆಚ್ಚು ಫೈಲ್‌ಗಳನ್ನು ಅಳಿಸಲಿದೆ.",
  ...
  // ---------------------------------------------------------- 利用者に出る失敗
  errNoOauthClient:
    "OAuth ಕ್ಲೈಂಟ್ ಹೊಂದಿಸಲಾಗಿಲ್ಲ — ಸೆಟ್ಟಿಂಗ್‌ಗಳಲ್ಲಿ ಕ್ಲೈಂಟ್ ID ಮತ್ತು ಸೀಕ್ರೆಟ್ ನಮೂದಿಸಿ, ನಂತರ ಸಂಪರ್ಕಿಸಿ.",
  errNoRefreshToken:
