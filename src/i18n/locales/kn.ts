...
export const kn: Strings = {
  ...
  // ------------------------------------------------ ローカル固有ファイルの分類
  sectionUnsorted: "ವಿಂಗಡಿಸದ",
  sectionShared: "ಹಂಚಿಕೊಳ್ಳಿ",
  sectionTrash: "ಅಳಿಸಿ",
  localOnlyIntro:
    "ಈ ವಾಲ್ಟ್‌ನಲ್ಲಿ ಇದ್ದು Drive ನಲ್ಲಿ ಇಲ್ಲದ ಫೈಲ್‌ಗಳು. ಪ್ರತಿ ಸಾಲನ್ನು “ಹಂಚಿಕೊಳ್ಳಿ” ಅಥವಾ “ಅಳಿಸಿ” ಗೆ ಸರಿಸಿ, ನಂತರ “ಸ್ಥಳೀಯ ಫೈಲ್‌ಗಳನ್ನು ವಿಂಗಡಿಸಿ” ಚಲಾಯಿಸಿ. ಈ ಫೈಲ್ ಎಂದಿಗೂ ಸಿಂಕ್ ಆಗುವುದಿಲ್ಲ.",
  localIgnoreTitle: "ನಿಮ್ಮ ಸ್ವಂತ ಹೊರತುಪಡಿಸುವ ನಿಯಮಗಳು",
  localIgnoreBody:
    "ಇಲ್ಲಿನ ನಿಯಮಗಳು ನಿಮ್ಮ ವಾಲ್ಟ್‌ಗೆ ಮಾತ್ರ ಅನ್ವಯಿಸುತ್ತವೆ; ಈ ಫೈಲ್ ಸಿಂಕ್ ಆಗುವುದಿಲ್ಲ. ಬರವಣಿಗೆ _Sync/ignore.md ನಂತೆಯೇ: # ಟಿಪ್ಪಣಿ, * ? ** ಗ್ಲೋಬ್, ಆರಂಭದ / ಸಿಂಕ್ ಮೂಲಕ್ಕೆ ಕಟ್ಟುತ್ತದೆ, ಕೊನೆಯ / ಫೋಲ್ಡರ್, ! ಹೊರತುಪಡಿಸುವಿಕೆಯನ್ನು ರದ್ದುಗೊಳಿಸುತ್ತದೆ.",
  btnOrganize: "ಸ್ಥಳೀಯ ಫೈಲ್‌ಗಳನ್ನು ವಿಂಗಡಿಸಿ",
  panelUnsorted: "ವಿಂಗಡಿಸದ",
  panelHeldUploads: "ತಡೆಹಿಡಿದ ಅಪ್‌ಲೋಡ್‌ಗಳು",
  panelLocalOnlyDesc: "ವಿಂಗಡಿಸದ ಪಟ್ಟಿ ಖಾಲಿಯಾಗುವವರೆಗೆ ಹೊಸ ಸ್ಥಳೀಯ ಫೈಲ್‌ಗಳು ಅಪ್‌ಲೋಡ್ ಆಗುವುದಿಲ್ಲ.",
  btnOpenLocalOnly: "ಪಟ್ಟಿ ತೆರೆಯಿರಿ",
  organizeDone: (shared, trashed) => `ಸ್ಥಳೀಯ ಫೈಲ್‌ಗಳನ್ನು ವಿಂಗಡಿಸಲಾಗಿದೆ — ಹಂಚಿಕೆ ${shared}, ಕಸದ ಬುಟ್ಟಿಗೆ ${trashed}`,
