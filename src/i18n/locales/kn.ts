...
export const kn: Strings = {
  ...
  localIgnoreBody:
    "ಇಲ್ಲಿನ ನಿಯಮಗಳು ನಿಮ್ಮ ವಾಲ್ಟ್‌ಗೆ ಮಾತ್ರ ಅನ್ವಯಿಸುತ್ತವೆ; ಈ ಫೈಲ್ ಸಿಂಕ್ ಆಗುವುದಿಲ್ಲ. ಬರವಣಿಗೆ _Sync/ignore.md ನಂತೆಯೇ: # ಟಿಪ್ಪಣಿ, * ? ** ಗ್ಲೋಬ್, ಆರಂಭದ / ಸಿಂಕ್ ಮೂಲಕ್ಕೆ ಕಟ್ಟುತ್ತದೆ, ಕೊನೆಯ / ಫೋಲ್ಡರ್, ! ಹೊರತುಪಡಿಸುವಿಕೆಯನ್ನು ರದ್ದುಗೊಳಿಸುತ್ತದೆ, ಆದರೆ ಹೊರತುಪಡಿಸಿದ ಫೋಲ್ಡರ್‌ನೊಳಗಿನ ಫೈಲ್‌ಗೆ ಅಲ್ಲ.",
