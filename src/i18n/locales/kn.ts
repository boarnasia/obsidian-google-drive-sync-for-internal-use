...
export const kn: Strings = {
  ...
  // ------------------------------------------------------------ 失敗の知らせ方
  failNetwork: "ನೆಟ್‌ವರ್ಕ್ ಸಂಪರ್ಕವಿಲ್ಲ. ಸಂಪರ್ಕ ಮರಳಿದ ಕೂಡಲೇ ಸಿಂಕ್ ತಾನಾಗಿ ಮುಂದುವರಿಯುತ್ತದೆ. ಈಗಲೇ ಪ್ರಯತ್ನಿಸಲು “ಸ್ಥಿತಿ ಪರಿಶೀಲಿಸಿ” ಒತ್ತಿ.",
  failServer: "Google Drive ಸದ್ಯಕ್ಕೆ ಪ್ರತಿಕ್ರಿಯಿಸುತ್ತಿಲ್ಲ. ಸ್ವಲ್ಪ ಹೊತ್ತಿನಲ್ಲಿ ಸಿಂಕ್ ತಾನಾಗಿ ಮುಂದುವರಿಯುತ್ತದೆ.",
  failAuth: "Google ಸೈನ್-ಇನ್ ಅವಧಿ ಮುಗಿದಿದೆ. ಸೆಟ್ಟಿಂಗ್‌ಗಳಿಂದ ಮರುಸಂಪರ್ಕಿಸಿ.",
  failTarget: "ಸಿಂಕ್ ಫೋಲ್ಡರ್ ತೆರೆಯಲಾಗುತ್ತಿಲ್ಲ. ಅದು ಕಸದ ಬುಟ್ಟಿಯಲ್ಲಿಲ್ಲ ಮತ್ತು ಹಂಚಿದ ಡ್ರೈವ್‌ಗೆ ಅನುಮತಿ ಇದೆಯೇ ಪರಿಶೀಲಿಸಿ.",
  failQuota: "Drive ನಲ್ಲಿ ಸ್ಥಳ ಮುಗಿದಿದೆ ಅಥವಾ ಫೈಲ್ ಮಿತಿ ತಲುಪಿದೆ. ನಿರ್ವಾಹಕರನ್ನು ಸಂಪರ್ಕಿಸಿ.",
  failDetail: (m) => `ವಿವರ: ${m}`,
  btnOpenSettings: "ಸೆಟ್ಟಿಂಗ್‌ಗಳನ್ನು ತೆರೆಯಿರಿ",
  tipOpenSettings: "ಮರುಸಂಪರ್ಕಕ್ಕಾಗಿ ಪ್ಲಗಿನ್ ಸೆಟ್ಟಿಂಗ್‌ಗಳನ್ನು ತೆರೆಯಿರಿ",
  failRetryIn: (x) => `ಸುಮಾರು ${x} ನಂತರ ಮರುಪ್ರಯತ್ನ`,
