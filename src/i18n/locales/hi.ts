...
export const hi: Strings = {
  ...
  panelPause: "सिंक रोकें",
  panelPauseDesc: "सिंक अपने आप चलता है। रोकने पर वह अपने आप नहीं चलेगा; 'अभी सिंक करें' फिर भी काम करता है।",
  panelPausedDesc: "रुका हुआ है: अपने आप कुछ सिंक नहीं होगा; 'अभी सिंक करें' फिर भी काम करता है।",
