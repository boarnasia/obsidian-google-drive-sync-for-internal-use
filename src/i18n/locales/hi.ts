...
export const hi: Strings = {
  ...
  // ------------------------------------------------ ローカル固有ファイルの分類
  sectionUnsorted: "अवर्गीकृत",
  sectionShared: "साझा करें",
  sectionTrash: "हटाएँ",
  localOnlyIntro:
    "इस वॉल्ट में मौजूद, पर Drive में नहीं मिलने वाली फ़ाइलें। हर पंक्ति को “साझा करें” या “हटाएँ” में ले जाएँ, फिर “स्थानीय फ़ाइलें छाँटें” चलाएँ। यह फ़ाइल कभी सिंक नहीं होती।",
  ...
  btnOrganize: "स्थानीय फ़ाइलें छाँटें",
  panelUnsorted: "अवर्गीकृत",
  panelHeldUploads: "रोके गए अपलोड",
  panelLocalOnlyDesc: "जब तक अवर्गीकृत सूची खाली नहीं होती, नई स्थानीय फ़ाइलें अपलोड नहीं होंगी।",
  btnOpenLocalOnly: "सूची खोलें",
  organizeDone: (shared, trashed) => `स्थानीय फ़ाइलें छाँटी गईं — साझा ${shared}, ट्रैश ${trashed}`,
