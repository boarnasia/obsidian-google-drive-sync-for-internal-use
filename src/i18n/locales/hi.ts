...
export const hi: Strings = {
  ...
  localIgnoreBody:
    "यहाँ लिखे नियम केवल आपके वॉल्ट पर लागू होते हैं; यह फ़ाइल सिंक नहीं होती। वाक्य-विन्यास _Sync/ignore.md जैसा ही है: # टिप्पणी, * ? ** ग्लोब, शुरुआती / सिंक रूट पर टिकाता है, अंतिम / फ़ोल्डर, ! बहिष्करण हटाता है, पर बहिष्कृत फ़ोल्डर के अंदर की फ़ाइल पर नहीं।",
