...
export const hi: Strings = {
  ...
  ribbonSyncNow: "Team Drive Sync: अभी सिंक करें",
  ...
  // ------------------------------------------------------------ 失敗の知らせ方
  failNetwork: "नेटवर्क कनेक्शन नहीं है। कनेक्शन लौटते ही सिंक अपने आप फिर शुरू होगा। अभी आज़माने के लिए “स्थिति जाँचें” दबाएँ।",
  failServer: "Google Drive अभी जवाब नहीं दे रहा। थोड़ी देर में सिंक अपने आप फिर शुरू होगा।",
  failAuth: "आपका Google साइन-इन समाप्त हो गया। सेटिंग्स से फिर कनेक्ट करें।",
  failTarget: "सिंक फ़ोल्डर नहीं खुल सका। देखें कि वह ट्रैश में तो नहीं है और शेयर्ड ड्राइव की अनुमति अब भी है।",
  failQuota: "Drive में जगह नहीं बची, या फ़ाइल सीमा पूरी हो गई। व्यवस्थापक से संपर्क करें।",
  failDetail: (m) => `विवरण: ${m}`,
  btnOpenSettings: "सेटिंग्स खोलें",
  tipOpenSettings: "फिर कनेक्ट करने के लिए प्लगइन सेटिंग्स खोलें",
  failRetryIn: (x) => `लगभग ${x} बाद फिर कोशिश`,
  ...
  panelIgnoreDesc:
    "टीम के बहिष्करण नियम सिंक फ़ोल्डर के शीर्ष पर .tds-ignore में हैं। Obsidian डॉट से शुरू होने वाली फ़ाइलें नहीं दिखाता, इसलिए इसे टेक्स्ट एडिटर में खोलें।",
  btnOpenFile: "खोलें",
  tipOpenFile: "टेक्स्ट एडिटर में खोलें",
  btnCopyPath: "पथ कॉपी करें",
  tipCopyPath: "पूरा पथ क्लिपबोर्ड पर कॉपी करें",
  pathCopied: (p) => `कॉपी किया: ${p}`,
  errOpenFailed: (m) => `फ़ाइल नहीं खुल सकी: ${m}`,

  // ------------------------------------------------------------ 版の目印
  panelVersionBehind: (mine, team) =>
    `यह प्लगइन पुराना है (आपका ${mine}, टीम का ${team})। अपडेट होने तक सिंक रुका है।`,
  panelVersionBehindDesc: "BRAT से प्लगइन अपडेट करें। संस्करण मिलते ही सिंक फिर शुरू होगा।",
  btnUpdateViaBrat: "BRAT से अपडेट करें",
  tipUpdateViaBrat: "BRAT का अपडेट जाँचें और अपडेट करें कमांड चलाएँ",
  errVersionBehind: (mine, team) =>
    `यह प्लगइन (${mine}) टीम के संस्करण (${team}) से पुराना है; सिंक के लिए अपडेट करें`,
